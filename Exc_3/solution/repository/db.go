...
func prepopulate(dbConn *gorm.DB) error {
	...
	// todo create drinks
	drinks := []model.Drink{
		{Name: "Cocacola", Description: "Cocacola zero sugar", Price: 2},
		{Name: "Fanta", Description: "Orange Fanta", Price: 1.5},
		{Name: "LateMacciato", Description: "Coffe with milk", Price: 1},
	}
